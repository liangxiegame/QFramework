    ...
    public sealed class MainThreadDispatcher : MonoBehaviour
    {
            ...
            if (!initialized)
            {
                ...
                catch
                {
                    ...
                    var ex = new Exception(
                        "QFramework requires a MainThreadDispatcher component created on the main thread. Make sure it is added to the scene before calling QFramework from a worker thread.");
        ...
        void Awake()
        {
            if (instance == null)
            {
                ...
                if (QFrameworkSynchronizationContext.AutoInstall)
                {
                    SynchronizationContext.SetSynchronizationContext(new QFrameworkSynchronizationContext());
                }
#endif
