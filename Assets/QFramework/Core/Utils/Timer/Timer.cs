...
namespace QFramework
{
    ...
    public class Timer : QMonoSingleton<Timer>
    {
        ...
        public TimeItem Post2Scale(PTVoidDelegate.WithGeneric<int> callback, float delay, int repeat)
        {
        ...
        public TimeItem Post2Really(PTVoidDelegate.WithGeneric<int> callback, float delay)
        {
            TimeItem item = TimeItem.Allocate(callback, delay);
            Post2Really(item);
            return item;
