...
{
    public static string luaDir = Application.dataPath + "/QFramework/Scriptkit/ToLua/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/QFramework/Scriptkit/ToLua/Lua";        //tolua lua文件目录
