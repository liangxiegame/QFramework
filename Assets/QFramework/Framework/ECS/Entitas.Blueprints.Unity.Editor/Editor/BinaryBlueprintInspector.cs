...
using QFramework.VisualDebugging.Unity.Editor;
using UnityEditor;
using UnityEditor.Callbacks;
using UnityEngine;


namespace QFramework.Blueprints.Unity.Editor {
    ...
    public class BinaryBlueprintInspector : UnityEditor.Editor {
        ...
        [DidReloadScripts, MenuItem("Tools/QFramework/Blueprints/Update all Blueprints", false, 300)]
