...
namespace QFramework.Migration
{
    ...
    public class M0360_2 : IMigration
    {
        ...
        string migrateTrigger(string fileContent)
        {
            ...
            if (groupEvent == "Added")
            {
                fileContent = Regex.Replace(fileContent, triggerPattern,
                    match => string.Format(triggerReplacement, oldMatcher));
            }
            else
            {
                fileContent = Regex.Replace(fileContent, triggerPattern,
        ...
        // TODO QFramework 0.36.0 Migration
        // ensure was: {0}
        // exclude was: {1}
        ...
        return {2};
            ...
            fileContent = Regex.Replace(fileContent, @"__filter_placeholder__",
                string.Format(filterReplacement, ensureMatcher, excludeMatcher, filter));
...
{1}
            ...
            {
                fileContent = Regex.Replace(fileContent, setPoolsPattern,
                    match => "// TODO QFramework 0.36.0 Migration (constructor)\n    " + match.Value);
                fileContent = Regex.Replace(fileContent, setPoolPattern,
                    match => "// TODO QFramework 0.36.0 Migration (constructor)\n    " + match.Value);
            }
