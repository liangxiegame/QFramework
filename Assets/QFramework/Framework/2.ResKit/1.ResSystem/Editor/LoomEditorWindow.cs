...
namespace QFramework
{
	public class LoomEditorWindow : EditorWindow
	{
		...
		private List<System.Action> _currentActions = new List<System.Action> ();
		...
		protected void QueueOnMainThread (System.Action action, float time)
		{
			if (time != 0) {
				lock (_delayed) {
		...
		protected Thread RunAsync (System.Action a)
		{
