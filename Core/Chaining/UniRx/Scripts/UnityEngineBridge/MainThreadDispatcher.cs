            ...
            if (!initialized)
            {
                ...
                catch
                {
                    ...
                    var ex = new Exception(
                        "PTGame.Framework requires a MainThreadDispatcher component created on the main thread. Make sure it is added to the scene before calling QFramework from a worker thread.");
