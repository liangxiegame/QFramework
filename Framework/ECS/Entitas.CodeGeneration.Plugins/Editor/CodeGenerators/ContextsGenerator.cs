...
@"public partial class Contexts : QFramework.IContexts {
...
${contextProperties}
    ...
    public QFramework.IContext[] allContexts { get { return new QFramework.IContext [] { ${contextList} }; } }
...
${contextAssignments}
        ...
        var postConstructors = System.Linq.Enumerable.Where(
            GetType().GetMethods(),
            method => System.Attribute.IsDefined(method, typeof(QFramework.CodeGeneration.Attributes.PostConstructorAttribute))
        );
