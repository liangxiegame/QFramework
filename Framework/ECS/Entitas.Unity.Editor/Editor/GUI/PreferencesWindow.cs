...
//            EntitasEditorLayout.ShowWindow<PreferencesWindow>("QFramework " + CheckForUpdates.GetLocalVersion());
        ...
        void DrawHeader()
        {
            ...
            {
                //Application.OpenURL("https://github.com/sschmid/QFramework-CSharp/blob/develop/README.md");
            }
        }
        ...
        void DrawException(Exception exception)
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.LabelField("Please make sure QFramework.properties is set up correctly.");
        }
    }
}