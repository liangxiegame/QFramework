...
namespace QFramework.Migration
{
    ...
    public class M0260 : IMigration
    {
        ...
        const string POOL_PATTERN_1 = @"var poolObserver = new QFramework.Unity.VisualDebugging.PoolObserver(";
        ...
        public MigrationFile[] Migrate(string path)
        {
            var files = MigrationUtils.GetFiles(path)
                .Where(file =>
                    file.fileContent.Contains(POOL_PATTERN_1) || file.fileContent.Contains(COMPONENT_PATTERN))
                .ToArray();
