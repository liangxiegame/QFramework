...
namespace QFramework
{
	...
	public partial class UIManager
	{
		...
		[Obsolete("UIManager.Instance.SetMatchOnWidthOrHeight() is depreacated,Please use UIKit.Root.SetMatchOnWidthOrHeight() instead",
			UIKitDeprecatedConfig.FORCE_DEPRECATED)]
		...
		[Obsolete("UIManager.Instance.GetMatchOnWithOrHeight() is depreacated,Please use UIKit.Root.GetMatchOnWithOrHeight() instead",
			UIKitDeprecatedConfig.FORCE_DEPRECATED)]
