    ...
    public class M0320 : IMigration
    {
        ...
        public MigrationFile[] Migrate(string path)
        {
            ...
            for (int i = 0; i < properties.Length; i++)
            {
                ...
                file.fileContent = file.fileContent.Replace("Entitas.Unity.CodeGenerator.GeneratedFolderPath",
                    "Entitas.CodeGenerator.GeneratedFolderPath");
                file.fileContent =
                    file.fileContent.Replace("Entitas.Unity.CodeGenerator.Pools", "Entitas.CodeGenerator.Pools");
                file.fileContent = file.fileContent.Replace("Entitas.Unity.CodeGenerator.EnabledCodeGenerators",
