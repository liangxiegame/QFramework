...
//            }
        ...
        public static T[] GetEnabledInstances<T>(Type[] types, string[] enabledTypeNames)
        ...
        public static string[] GetAvailable<T>(Type[] types, string[] enabledTypeNames)
            where T : ICodeGeneratorInterface
        {
        ...
        public static string[] GetUnavailable<T>(Type[] types, string[] enabledTypeNames)
            where T : ICodeGeneratorInterface
        {
        ...
        public static Dictionary<string, string> GetConfigurables(ICodeGeneratorDataProvider[] dataProviders,
