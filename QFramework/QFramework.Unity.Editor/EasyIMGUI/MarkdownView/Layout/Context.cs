...
namespace MG.MDV
{
    public class Context
    {
        ...
        public void     Reset()                         { Apply( MarkdownStyle.Default ); }
        public GUIStyle Apply( MarkdownStyle style )            { mStyleGUI = mStyleConverter.Apply( style ); return mStyleGUI; }
