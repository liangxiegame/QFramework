...
namespace QFramework.Core.Rx
{
    ...
    public static partial class Observable
    {
        ...
        {
            return ToObservable(source, Utils.Scheduler.Scheduler.DefaultSchedulers.Iteration);
        }

        public static IObservable<T> ToObservable<T>(this IEnumerable<T> source, Utils.Scheduler.IScheduler scheduler)
        {
