...
namespace QFramework.Core.Rx
{
    ...
    internal class TimeoutObservable<T> : OperatorObservableBase<T>
    {
        ...
        public TimeoutObservable(IObservable<T> source, TimeSpan dueTime, Utils.Scheduler.IScheduler scheduler) 
        ...
        public TimeoutObservable(IObservable<T> source, DateTimeOffset dueTime, Utils.Scheduler.IScheduler scheduler) 
            : base(scheduler ==Utils.Scheduler. Scheduler.CurrentThread || source.IsRequiredSubscribeOnCurrentThread())
        {
            this.source = source;
