...
namespace QFramework.Core.Rx
{
    ...
    internal class TakeObservable<T> : OperatorObservableBase<T>
    {
        ...
        internal readonly Utils.Scheduler.IScheduler scheduler; // public for optimization check
        ...
        public TakeObservable(IObservable<T> source, TimeSpan duration, Utils.Scheduler.IScheduler scheduler)
