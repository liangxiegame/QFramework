...
namespace QFramework.Unity.Editor {
    ...
    public static class EntitasMenuItems {
        ...
        public const string preferences                      = "Tools/QFramework/Preferences... #%e";

        public const string check_for_updates                = "Tools/QFramework/Check for Updates...";

        public const string documentation                    = "Tools/QFramework/Documentation...";

        public const string feedback_report_a_bug            = "Tools/QFramework/Feedback/Report a bug...";
        public const string feedback_request_a_feature       = "Tools/QFramework/Feedback/Request a feature...";
        public const string feedback_join_the_entitas_chat   = "Tools/QFramework/Feedback/Join the QFramework chat...";
        public const string feedback_entitas_wiki            = "Tools/QFramework/Feedback/QFramework Wiki...";
        public const string feedback_donate                  = "Tools/QFramework/Feedback/Donate...";
    }
    ...
    public static class EntitasFeedback {
        ...
        public static void EntitasDocs() {
            Application.OpenURL("http://sschmid.github.io/QFramework-CSharp/");
        }

        [MenuItem(EntitasMenuItems.feedback_report_a_bug, false, EntitasMenuItemPriorities.feedback_report_a_bug)]
        public static void ReportBug() {
            Application.OpenURL("https://github.com/sschmid/QFramework-CSharp/issues");
        }
        ...
        public static void EntitasChat() {
            Application.OpenURL("https://gitter.im/sschmid/QFramework-CSharp");
        }
        ...
        public static void EntitasWiki() {
            Application.OpenURL("https://github.com/sschmid/QFramework-CSharp/wiki");
        }
