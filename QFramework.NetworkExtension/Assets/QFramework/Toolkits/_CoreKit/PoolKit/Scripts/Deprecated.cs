...
{
    [Obsolete("请使用 SafeObjectPool，通过设置 NonPublicObjectFactory 对象来替代,please use SafeObjectPool and set NonPublicObjectFactory instead",true)]
    ...
    [Obsolete("请使用 PoolableObject,please use PoolableObject instead",true)]
