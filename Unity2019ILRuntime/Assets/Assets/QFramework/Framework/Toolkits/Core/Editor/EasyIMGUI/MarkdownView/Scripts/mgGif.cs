...
namespace MG.GIF
{
    ...
    {
        public static bool HasFlag(this Decoder.ImageFlag flag, Decoder.ImageFlag value)
        {
    ...
    public class Decoder : IDisposable
    {
        ...
        void ReadHeader()
        {
            ...
            if ((flags & ImageFlag.ColourTable) == ImageFlag.ColourTable)
            {
        ...
        void ReadControlBlock()
        {
            ...
            if ((flags & ControlFlags.HasTransparency) == ControlFlags.HasTransparency)
            {
